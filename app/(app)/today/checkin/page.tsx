    ...
    <main>
      ...
      {sliders.map(([label, q]) => (
        <Card key={label} className="mt-4">
          ...
          <input type="range" min={1} max={10} defaultValue={5} className="mt-3 w-full accent-[#7DD6E0]" />
        </Card>
      ))}
      <Card className="mt-4">
      ...
      <a href="/today" className="mt-6 block text-center rounded-full bg-mist py-3 font-medium text-ink">
